...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem(File directory) {
    ...
    try {
      if (Constants.OperatorConstants.WORKSHOP_MODE) {
        swerveDrive = new SwerveParser(directory).createSwerveDrive(Globals.workShopSettings.maxSpeed,
   ...
   */
  public edu.wpi.first.wpilibj2.command.Command centerModulesCommand() {
